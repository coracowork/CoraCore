...
mod tests {
    ...
    use cora_cowork_db::{DbError, IChannelRepository, IClientPreferenceRepository, UpdatePluginStatusParams};
    ...
    async fn session_new_creates_session() {
        ...
        match result {
            MessageResult::Action(resp) => {
                ...
                // With no client_preferences configured, defaults to "corars"
