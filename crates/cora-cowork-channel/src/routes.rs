...
use cora_cowork_db::{DbError, IChannelRepository};
use cora_cowork_extension::{ExtensionRegistry, ResolvedChannelPlugin};
use serde::Serialize;
...
mod tests {
    use super::*;
    use cora_cowork_api_types::TestPluginExtraConfig;
