...
mod weixin_tests {
    ...
    use cora_cowork_channel::manager::{ChannelManager, PluginFactory};
    use cora_cowork_channel::plugin::ChannelPlugin;
    use cora_cowork_channel::plugins::weixin::WeixinPlugin;
    use cora_cowork_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use cora_cowork_channel::plugins::weixin::weixin_login_stream;
