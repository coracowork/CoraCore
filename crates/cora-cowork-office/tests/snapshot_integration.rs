use cora_cowork_api_types::{PreviewHistoryTargetDto, PreviewSnapshotInfoDto};
use cora_cowork_common::PreviewContentType;
use cora_cowork_office::SnapshotService;
