...
// from many server deployments (coracowork#3212 follow-up).
...
pub(crate) const OFFICECLI_INSTALL_SH_URL: &str =
    "https://raw.githubusercontent.com/coracowork/OfficeCLI/main/install.sh";
pub(crate) const OFFICECLI_INSTALL_PS1_URL: &str =
    "https://raw.githubusercontent.com/coracowork/OfficeCLI/main/install.ps1";
pub(crate) const OFFICECLI_LATEST_RELEASE_URL: &str = "https://github.com/coracowork/OfficeCLI/releases/latest";
...
mod tests {
    ...
    fn official_installer_commands_use_official_officecli_channel() {
        ...
        assert!(unix_text.contains("coracowork/OfficeCLI/main/install.sh"));
        assert!(windows_text.contains("coracowork/OfficeCLI/main/install.ps1"));
    }

    // Servers that cannot reach raw.githubusercontent.com (the common case on
    // mainland-China clouds, see coracowork#3212 follow-up) must still be able to
    ...
    fn installer_commands_try_mirror_before_github() {
        ...
        let unix_github = unix_text.find("coracowork/OfficeCLI/main/install.sh");
        ...
        let windows_github = windows_text.find("coracowork/OfficeCLI/main/install.ps1");
        assert!(
