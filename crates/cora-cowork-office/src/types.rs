...
impl DocType {
    ...
    pub fn corecli_subcommand(&self) -> &'static str {
        "watch"
    }
}
...
mod tests {
    ...
    #[test]
    fn doc_type_corecli_subcommand() {
        assert_eq!(DocType::Word.corecli_subcommand(), "watch");
        assert_eq!(DocType::Excel.corecli_subcommand(), "watch");
        assert_eq!(DocType::Ppt.corecli_subcommand(), "watch");
    }
    ...
    #[test]
    fn corecli_status_variants() {
        let statuses = [
            CorecliStatus::Starting,
            CorecliStatus::Installing,
            CorecliStatus::Ready,
            CorecliStatus::Error,
        ];
        assert_eq!(statuses.len(), 4);
        assert_ne!(CorecliStatus::Starting, CorecliStatus::Ready);
    }
}
