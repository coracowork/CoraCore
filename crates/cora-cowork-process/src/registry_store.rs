...
//!
//! Lives in its own subdir `{data_dir}/runtime/cora-cowork-process/registry.json`,
...
pub const SUBDIR: &str = "runtime/cora-cowork-process";
...
/// File-backed registry under `{data_dir}/runtime/cora-cowork-process/registry.json`.
