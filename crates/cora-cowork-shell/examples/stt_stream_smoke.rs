...
//!   cargo run -p cora-cowork-shell --example stt_stream_smoke -- /path/to/pcm16-24k-mono.wav

use cora_cowork_api_types::{
    DeepgramSpeechToTextConfig, OpenAISpeechToTextConfig, SpeechToTextConfig, SpeechToTextProvider,
};
use cora_cowork_shell::{ProviderUpstreamFactory, UpstreamEvent, UpstreamFactory};
