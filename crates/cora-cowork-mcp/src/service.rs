...
use cora_cowork_db::{CreateMcpServerParams, IMcpServerRepository, UpdateMcpServerParams};
...
mod tests {
    use super::*;
    use cora_cowork_api_types::{ImportMcpServerRequest, McpTransport};
    use cora_cowork_common::{McpServerStatus, TimestampMs};
    use cora_cowork_db::models::McpServerRow;
    use cora_cowork_db::{CreateMcpServerParams, DbError, UpdateMcpServerParams};
    ...
    async fn persist_test_result_records_success_status_and_tools() {
        ...
        let result = McpConnectionTestResult {
            success: true,
            tools: Some(vec![cora_cowork_api_types::McpToolResponse {
                name: "read_file".into(),
        ...
        assert_eq!(updated.last_test_status, cora_cowork_common::McpServerStatus::Connected);
    ...
    async fn persist_test_result_records_error_and_clears_tools() {
        ...
        let updated = svc.get_server(&created.id).await.unwrap();
        assert_eq!(updated.last_test_status, cora_cowork_common::McpServerStatus::Error);
