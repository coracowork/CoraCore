...
use cora_cowork_api_types::{DetectedMcpServerEntry, DetectedMcpServerResponse};
...
fn detected_to_response(detected: DetectedServer) -> DetectedMcpServerEntry {
    ...
    DetectedMcpServerEntry {
        server: cora_cowork_api_types::McpServerResponse {
            ...
            tools: None,
            last_test_status: cora_cowork_common::McpServerStatus::Disconnected,
            last_connected: None,
            original_json: None,
            builtin: false,
            created_at: 0,
