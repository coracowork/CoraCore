...
use cora_cowork_db::{IOAuthTokenRepository, SqliteOAuthTokenRepository, UpsertOAuthTokenParams};
use cora_cowork_mcp::McpOAuthService;
...
async fn check_status_authenticated_returns_true() {
    ...
    repo.upsert(UpsertOAuthTokenParams {
        ...
        expires_at: Some(cora_cowork_common::now_ms() + 3_600_000),
    })
    .await
    .unwrap();
