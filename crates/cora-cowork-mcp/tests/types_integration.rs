//! Integration tests for cora-cowork-mcp core types.
//!
...
use cora_cowork_mcp::{McpServer, McpServerTransport, McpTool};
...
fn tool_fields_preserved_through_conversion() {
    ...
    // Domain -> API response
    let resp: cora_cowork_api_types::McpToolResponse = tool.clone().into();
