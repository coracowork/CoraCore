...
use cora_cowork_api_types::{CreateProviderRequest, ProviderResponse, UpdateProviderRequest};
use cora_cowork_common::{decrypt_string, encrypt_string};
use cora_cowork_db::{CreateProviderParams, IProviderRepository, UpdateProviderParams, models::Provider};
...
mod tests {
    use super::*;
    use cora_cowork_db::{SqliteProviderRepository, init_database_memory};
    ...
    fn validate_create_bedrock_allows_empty_base_url_and_api_key() {
        let req = CreateProviderRequest {
            ...
            base_url: "".into(),
            api_key: "".into(),
            bedrock_config: Some(cora_cowork_api_types::BedrockConfig {
                auth_method: cora_cowork_api_types::BedrockAuthMethod::Profile,
