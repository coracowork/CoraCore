use cora_cowork_api_types::{GitHubReleaseAsset, UpdateCheckRequest, UpdateCheckResult, UpdateReleaseInfo};
use serde::Deserialize;

use crate::error::SystemError;

const DEFAULT_REPO: &str = "coracowork/cora-cowork-desktop";
...
fn resolve_repo(from_request: Option<&str>) -> String {
    ...
    if let Ok(v) = std::env::var("CORA_COWORK_GITHUB_REPO")
        && !v.is_empty()
    {
        return v;
    }
