...
//! `cora-cowork-file`) so the file domain crate needs no dependency on the shell
...
use cora_cowork_file::{FileError, ISystemFileOpener};
use cora_cowork_shell::{ShellError, ShellService};
