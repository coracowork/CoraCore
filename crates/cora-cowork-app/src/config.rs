...
impl AppConfig {
    ...
    pub fn database_path(&self) -> PathBuf {
        self.data_dir.join("cora-cowork-backend.db")
    }
}
...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            host: cora_cowork_common::constants::DEFAULT_HOST.to_string(),
            port: cora_cowork_common::constants::DEFAULT_PORT,
...
pub fn derive_encryption_key(jwt_secret: &str) -> [u8; 32] {
    ...
    hasher.update(b"cora-cowork-encryption-key:");
