...
use cora_cowork_app::{AppConfig, AppServices, build_module_states, create_router_with_states, derive_encryption_key};
use cora_cowork_common::{decrypt_string, now_ms};
...
async fn eq19_channel_status_merges_extension_meta_for_persisted_row() {
    ...
    let now = now_ms();
    repo.upsert_plugin(&cora_cowork_db::models::ChannelPluginRow {
