...
- "While the build script is running, the `.pptx` may be rewritten several times. If you want to preview progress, use `corecli watch "$FILE"` and open the live preview in Cora — do NOT click 'Open with system app' during the build, or you'll hit a file lock."
