...
corecli create "$OUT"
corecli add "$OUT" '/' --type slide --prop layout=blank --prop background=0B0F1A --prop transition=morph

cat <<'JSON' | corecli batch "$OUT"
[
