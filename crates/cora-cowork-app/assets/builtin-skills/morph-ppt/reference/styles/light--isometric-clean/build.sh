...
# ===================== SLIDE 1: hero =====================
corecli add "$DECK" '/' --type slide --prop layout=blank --prop background=F0F4F8
...
# ===================== SLIDE 2: statement =====================
corecli add "$DECK" '/' --type slide --prop layout=blank --prop background=F0F4F8 --prop transition=morph
