...
corecli add "$OUTPUT" '/' --type slide --prop layout=blank --prop background=$OFFWHITE
...
corecli add "$OUTPUT" '/' --type slide --prop layout=blank --prop background=$BLACK
corecli set "$OUTPUT" '/slide[2]' --prop transition=morph

# Scene actors: color blocks (moved)
corecli add "$OUTPUT" '/slide[2]' --type shape \
  --prop 'name=!!blk-a' \
  --prop fill=$RED \
...
# Scene actors: color blocks (moved)
corecli add "$OUTPUT" '/slide[3]' --type shape \
  --prop 'name=!!blk-a' \
  --prop fill=$RED \
...
# Scene actors: color blocks (moved)
corecli add "$OUTPUT" '/slide[4]' --type shape \
  --prop 'name=!!blk-a' \
  --prop fill=$RED \
...
corecli add "$OUTPUT" '/' --type slide --prop layout=blank --prop background=$RED
corecli set "$OUTPUT" '/slide[5]' --prop transition=morph

# Scene actors: color blocks (moved - full coverage)
corecli add "$OUTPUT" '/slide[5]' --type shape \
  --prop 'name=!!blk-a' \
  --prop fill=$RED \
