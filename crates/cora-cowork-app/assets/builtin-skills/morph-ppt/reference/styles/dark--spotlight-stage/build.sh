...
# ===================== SLIDE 1: hero =====================
corecli add "$DECK" '/' --type slide --prop layout=blank --prop background=0A0A0A

cat <<'BATCH' | corecli batch "$DECK"
[
...
# ===================== SLIDE 2: statement =====================
corecli add "$DECK" '/' --type slide --prop layout=blank --prop background=0A0A0A --prop transition=morph
...
# ===================== VALIDATE =====================
corecli validate "$DECK"
corecli view "$DECK" outline
