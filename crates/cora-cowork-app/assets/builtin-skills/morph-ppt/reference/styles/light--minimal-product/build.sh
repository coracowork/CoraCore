...
# Morph scene actors
corecli set "$OUTPUT" '/slide[2]/shape[1]' --prop x=2cm --prop y=2cm --prop width=4cm --prop height=4cm --prop opacity=0.06
corecli set "$OUTPUT" '/slide[2]/shape[2]' --prop x=28cm --prop y=12cm --prop width=5cm --prop height=5cm --prop opacity=0.04
corecli set "$OUTPUT" '/slide[2]/shape[3]' --prop x=0cm --prop y=0cm --prop width=0.1cm --prop height=0.1cm
corecli set "$OUTPUT" '/slide[2]/shape[4]' --prop fill=$DARK
...
corecli set "$OUTPUT" '/slide[2]/shape[11]' --prop x=9cm
corecli set "$OUTPUT" '/slide[2]/shape[12]' --prop x=9cm
corecli set "$OUTPUT" '/slide[2]/shape[13]' --prop x=12cm
corecli set "$OUTPUT" '/slide[2]/shape[14]' --prop x=9cm
corecli set "$OUTPUT" '/slide[2]/shape[15]' --prop x=9cm
corecli set "$OUTPUT" '/slide[2]/shape[16]' --prop x=9cm
corecli set "$OUTPUT" '/slide[2]/shape[17]' --prop x=2cm
corecli set "$OUTPUT" '/slide[2]/shape[18]' --prop x=2.8cm
corecli set "$OUTPUT" '/slide[2]/shape[19]' --prop x=2cm
corecli set "$OUTPUT" '/slide[2]/shape[20]' --prop x=2.8cm
corecli set "$OUTPUT" '/slide[2]/shape[21]' --prop x=2cm
corecli set "$OUTPUT" '/slide[2]/shape[22]' --prop x=2.8cm
corecli set "$OUTPUT" '/slide[2]/shape[23]' --prop x=26cm
corecli set "$OUTPUT" '/slide[2]/shape[24]' --prop x=26cm
...
# Morph scene actors
corecli set "$OUTPUT" '/slide[3]/shape[1]' --prop x=1cm --prop y=12cm --prop width=5cm --prop height=5cm --prop opacity=0.06
corecli set "$OUTPUT" '/slide[3]/shape[2]' --prop x=28cm --prop y=2cm --prop width=4cm --prop height=4cm --prop opacity=0.04
corecli set "$OUTPUT" '/slide[3]/shape[3]' --prop x=0cm --prop y=0cm --prop width=0.1cm --prop height=0.1cm
corecli set "$OUTPUT" '/slide[3]/shape[4]' --prop fill=$GREEN
...
corecli set "$OUTPUT" '/slide[3]/shape[25]' --prop x=2cm
corecli set "$OUTPUT" '/slide[3]/shape[26]' --prop x=2cm
corecli set "$OUTPUT" '/slide[3]/shape[27]' --prop x=15cm
...
# Morph scene actors
corecli set "$OUTPUT" '/slide[4]/shape[1]' --prop x=3cm --prop y=14cm --prop width=4cm --prop height=4cm --prop opacity=0.06
corecli set "$OUTPUT" '/slide[4]/shape[2]' --prop x=27cm --prop y=3cm --prop width=4cm --prop height=4cm --prop opacity=0.04
corecli set "$OUTPUT" '/slide[4]/shape[3]' --prop x=0cm --prop y=0cm --prop width=0.1cm --prop height=0.1cm
corecli set "$OUTPUT" '/slide[4]/shape[4]' --prop fill=$DARK
...
corecli set "$OUTPUT" '/slide[4]/shape[28]' --prop x=2cm
corecli set "$OUTPUT" '/slide[4]/shape[29]' --prop x=2cm
...
# Morph scene actors
corecli set "$OUTPUT" '/slide[5]/shape[1]' --prop x=28cm --prop y=10cm --prop width=5cm --prop height=5cm --prop opacity=0.06
corecli set "$OUTPUT" '/slide[5]/shape[2]' --prop x=1cm --prop y=3cm --prop width=4cm --prop height=4cm --prop opacity=0.04
corecli set "$OUTPUT" '/slide[5]/shape[3]' --prop x=0cm --prop y=0cm --prop width=0.1cm --prop height=0.1cm
corecli set "$OUTPUT" '/slide[5]/shape[4]' --prop fill=$GREEN
...
corecli set "$OUTPUT" '/slide[5]/shape[30]' --prop x=2cm
corecli set "$OUTPUT" '/slide[5]/shape[31]' --prop x=2cm
...
# Morph scene actors
corecli set "$OUTPUT" '/slide[6]/shape[1]' --prop x=5cm --prop y=1cm --prop width=3cm --prop height=3cm --prop opacity=0.15
corecli set "$OUTPUT" '/slide[6]/shape[2]' --prop x=26cm --prop y=5cm --prop width=4cm --prop height=4cm --prop opacity=0.08 --prop fill=$WHITE
corecli set "$OUTPUT" '/slide[6]/shape[3]' --prop x=0cm --prop y=0cm --prop width=0.1cm --prop height=0.1cm
corecli set "$OUTPUT" '/slide[6]/shape[4]' --prop fill=$GREEN
...
corecli set "$OUTPUT" '/slide[6]/shape[32]' --prop x=0cm
corecli set "$OUTPUT" '/slide[6]/shape[33]' --prop x=2cm
corecli set "$OUTPUT" '/slide[6]/shape[34]' --prop x=2cm
corecli set "$OUTPUT" '/slide[6]/shape[35]' --prop x=2cm
corecli set "$OUTPUT" '/slide[6]/shape[36]' --prop x=11cm
corecli set "$OUTPUT" '/slide[6]/shape[37]' --prop x=11cm
