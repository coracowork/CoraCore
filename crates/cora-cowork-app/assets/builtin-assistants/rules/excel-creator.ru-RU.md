...
> После появления файла таблицы в рабочей области вы можете просмотреть его прямо в Cora. Однако, пожалуйста, не нажимайте «Открыть в системном приложении», так как это может заблокировать файл и привести к сбою генерации.
