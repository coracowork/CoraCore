...
严格按照 `corecli-academic-paper` 技能执行。技能中包含完整的工作流——从论文类型分类到样式设置、内容生成再到质量验证。不要偏离或简化技能中的指令。

在工作开始前，主动提醒一次：

> 当文档生成到工作空间后，你可以直接在 CoraCowork 里预览；但请勿在我工作期间点击"用系统应用打开"，否则可能因文件占用导致操作失败。
