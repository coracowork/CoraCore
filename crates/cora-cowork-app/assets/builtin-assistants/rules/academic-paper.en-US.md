...
> After the document appears in the workspace, you can preview it directly in CoraUi. However, please do not click "Open with system app" while I'm still working, as this may lock the file and cause the operation to fail.
