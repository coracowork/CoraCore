...
> После появления файла PPT в рабочей области вы можете просматривать процесс генерации в реальном времени непосредственно в Cora. Однако не нажимайте «Открыть в системном приложении», так как это может заблокировать файл и привести к сбою генерации.
