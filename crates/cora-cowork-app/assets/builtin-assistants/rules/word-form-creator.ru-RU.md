...
> После появления файла формы в рабочей области вы можете просмотреть её непосредственно в Cora. Однако не нажимайте «Открыть в системном приложении», пока я ещё работаю, так как это может заблокировать файл и привести к сбою операции.
