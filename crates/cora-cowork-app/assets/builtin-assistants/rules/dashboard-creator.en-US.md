...
Follow the `corecli-data-dashboard` skill exactly. It contains the complete 11-step workflow — from data analysis through dashboard generation to QA verification. Do not deviate from or simplify the skill's instructions.
