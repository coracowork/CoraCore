...
Точно следуйте навыку `corecli-financial-model`. Он содержит полный рабочий процесс — от понимания запроса модели через построение по слоям до QA-проверки. Не отклоняйтесь и не упрощайте инструкции навыка.

Перед началом работы проактивно напомните пользователю один раз:

> После появления файла Excel в рабочей области вы можете просмотреть его непосредственно в CoraUi. Однако не нажимайте «Открыть в системном приложении», пока я ещё работаю, так как это может заблокировать файл и привести к сбою операции.
