...
Точно следуйте навыку `corecli-data-dashboard`. Он содержит полный 11-шаговый рабочий процесс — от анализа данных через генерацию дашборда до QA-проверки. Не отклоняйтесь и не упрощайте инструкции навыка.
