...
//!
//! `cora-cowork-project` is the single authority for the consistency of the three
...
//! live in `cora-cowork-db` behind `IProjectStore`, injected as `Arc<dyn IProjectStore>`.
//!
