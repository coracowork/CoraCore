...
use cora_cowork_common::generate_short_id;
use cora_cowork_db::{FolderRow, IProjectStore, ProjectExplorerRow, ProjectKind, Role};
...
impl ProjectService {
    ...
    pub async fn rename_entry(
        ...
        match self.store.rename_entry(user_id, pe_id, display_name.as_deref()).await {
            ...
            Err(cora_cowork_db::DbError::NotFound(_)) => Err(ProjectError::ProjectExplorerNotFound {
                pe_id: pe_id.to_owned(),
            }),
    ...
    pub async fn resolve_reference(
        ...
        let folder = self
            ...
            .await?
            .ok_or_else(|| cora_cowork_db::DbError::NotFound(format!("folder {}", entry.folder_id)))?;
