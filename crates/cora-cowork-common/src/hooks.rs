...
//!
//! Hooks defined here let lower-layer crates (e.g. `cora-cowork-ai-agent`,
//! `cora-cowork-cron`) react to events owned by higher-layer crates (e.g.
//! `cora-cowork-conversation`) without forming a dependency cycle.
