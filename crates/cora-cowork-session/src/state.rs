...
/// codex fills only label, and ACP/corars have no workflow concept (empty roster).
...
/// with a Workflow and was WRONG. Re-measured on claude 2.1.176 (CoraCore's exact
...
mod tests {
    ...
    fn can_queue_truth_table_capability_gated() {
        ...
        // acp/corars (accepts_proactive_input=false): degrades to false in
