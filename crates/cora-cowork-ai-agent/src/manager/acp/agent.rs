...
impl AcpAgentManager {
    ...
    pub(crate) async fn mode(&self) -> Result<cora_cowork_api_types::AgentModeResponse, AgentError> {
        let desired = self
            .session
            .read()
            .await
...
mod tests {
    ...
    fn session_command_loading_preserves_empty_turn_meta() {
        ...
        assert_eq!(
            ...
            Some(cora_cowork_api_types::SlashCommandCompletionBehavior::NeutralTipOnEmpty)
        );
        assert_eq!(
