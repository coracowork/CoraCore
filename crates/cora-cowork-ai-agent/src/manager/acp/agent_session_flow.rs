...
use cora_cowork_api_types::SlashCommandItem;
...
impl AcpAgentManager {
    ...
    async fn emit_snapshot_events(&self) {
        use cora_cowork_api_types::{ModelInfoEntry, ModelInfoPayload};
...
mod tests {
    ...
    use cora_cowork_api_types::{AgentErrorCode, SlashCommandCompletionBehavior, SlashCommandItem};
