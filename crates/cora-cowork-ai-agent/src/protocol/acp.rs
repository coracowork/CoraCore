...
const ACP_CLIENT_NAME: &str = "CoraCowork";
...
/// Log a JSON-RPC request from CoraCowork to the ACP agent.
...
/// Log a fire-and-forget notification from CoraCowork to the agent.
...
/// Log a JSON-RPC response from CoraCowork back to the agent.
...
mod tests {
    ...
    fn initialize_request_sends_non_empty_client_info() {
        ...
        assert_eq!(client_info.name, "CoraCowork");
        ...
        assert_eq!(json["clientInfo"]["name"], "CoraCowork");
