...
/// the web UI; `DENY` here blanks the preview (coracowork/cora-cowork-desktop#3177).
...
mod tests {
    ...
    async fn office_proxy_routes_get_sameorigin_frame_headers() {
        // Regression for coracowork/cora-cowork-desktop#3177: the office preview proxies
