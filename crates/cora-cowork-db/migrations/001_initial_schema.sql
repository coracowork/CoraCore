-- Migration 001: Consolidated initial schema for cora-cowork-backend
--
-- This is the baseline schema for databases copied from the legacy
-- Electron-managed cora-cowork.db (v26). It creates all tables, indexes,
...
VALUES
    ...
    -- Internal
    ('632f31d2', '/api/assets/logos/brand/cora.svg', 'Cora CLI',
     NULL, 'corars', 'internal', '{}',
     1, NULL, '[]', '[]',
     '[".corars/skills"]',
     '{"supports_team":true}',
     'yolo', 100,
