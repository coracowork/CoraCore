...
--
-- When cora-cowork-backend.db is created by copying the Electron-managed cora-cowork.db,
...
-- database copied from cora-cowork.db retains its original DDL (CHECK
