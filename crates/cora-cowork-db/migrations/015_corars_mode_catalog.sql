-- Migration 015: persist the built-in corars mode catalog.
--
-- corars is not an ACP backend, so it does not populate agent_metadata through
...
-- stable corars runtime mode catalog here.
