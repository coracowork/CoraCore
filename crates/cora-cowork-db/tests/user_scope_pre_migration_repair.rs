...
use cora_cowork_db::init_database_staged;
...
/// stopped at v29 (CoraCore 0.1.52 stops at 28) jumps straight to a build with
...
async fn max_applied_version(db: &cora_cowork_db::Database) -> i64 {
...
async fn v28_start_point_self_heals_across_029_and_030() {
    // ELECTRON-31Z root case: a DB stopped at v28 (CoraCore 0.1.52) upgrades in
