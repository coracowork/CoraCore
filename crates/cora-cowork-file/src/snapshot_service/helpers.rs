...
pub(super) const SNAPSHOT_DIR_PREFIX: &str = "cora-cowork-snapshot-";
...
const SNAPSHOT_SIG_NAME: &str = "cora-cowork";
/// Signature email used for snapshot commits.
const SNAPSHOT_SIG_EMAIL: &str = "snapshot@cora-cowork.local";
...
pub(super) struct WorkspaceState {
    ...
    /// - snapshot mode: `/tmp/cora-cowork-snapshot-{hash}` (bare-style git dir).
