...
use cora_cowork_api_types::{BrowseDirectoryResponse, BrowseEntry};
...
/// projects (coracowork/cora-cowork-desktop#3191) — so strip the prefix before serializing.
...
mod tests {
    ...
    // Regression tests for coracowork/cora-cowork-desktop#3191: responses must never carry
