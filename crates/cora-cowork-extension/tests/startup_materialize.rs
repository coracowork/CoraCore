...
use cora_cowork_extension::startup_materialize::{materialize_embedded_builtin_skills, materialize_if_needed};
...
async fn gate_triggers_when_existing_marker_lacks_corpus_fingerprint() {
    ...
    let marker = cora_cowork_extension::builtin_skills_materialize_marker(&FIXTURE_CORPUS, "1.2.3");
