...
mod tests {
    ...
    #[test]
    fn test_reserved_prefix_cora() {
        let manifest = ExtensionManifest {
            name: "cora-my-ext".into(),
            version: "1.0.0".into(),
            display_name: None,
            description: None,
            author: None,
        ...
        assert!(matches!(
            err,
            ExtensionError::ReservedNamePrefix { ref prefix, .. } if prefix == "cora-"
        ));
    }
    ...
    #[test]
    fn test_parse_manifest_in_dir_supports_cora_cowork_main_contract() {
