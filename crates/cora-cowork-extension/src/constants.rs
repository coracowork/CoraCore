...
pub const EXTENSION_MANIFEST_FILE: &str = "cora-extension.json";
...
pub const RESERVED_NAME_PREFIXES: &[&str] = &["cora-", "internal-", "builtin-", "system-"];
...
/// Well-known skill source name for the cora-cowork skills market.
pub const SKILLS_MARKET_NAME: &str = "cora-cowork-skills";

/// Well-known skill source path for the cora-cowork skills market.
///
...
pub const SKILLS_MARKET_PATH: &str = "https://github.com/coracowork/cora-cowork-skills";
...
mod tests {
    ...
    fn test_manifest_file_name() {
        assert_eq!(EXTENSION_MANIFEST_FILE, "cora-extension.json");
    }

    #[test]
    fn test_reserved_prefixes_contains_expected() {
        assert!(RESERVED_NAME_PREFIXES.contains(&"cora-"));
