...
///
/// Data is stored in `~/.cora-cowork/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable the cora-cowork skills market by adding it to external paths.
    ...
    /// Disable the cora-cowork skills market by removing it from external paths.
