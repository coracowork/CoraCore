...
use cora_cowork_common::{ApiError, now_ms};
use serde_json::json;
...
impl From<ExtensionError> for ApiError {
    fn from(err: ExtensionError) -> Self {
        match err {
            ...
            ExtensionError::Db(cora_cowork_db::DbError::NotFound(msg)) => ApiError::NotFound(msg),
            ExtensionError::Db(cora_cowork_db::DbError::Conflict(msg)) => ApiError::Conflict(msg),
