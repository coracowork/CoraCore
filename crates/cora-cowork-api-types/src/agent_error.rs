...
pub enum AgentErrorCode {
    CoraCoworkConversationBusy,
    CoraCoworkStreamBroken,
    CoraCoworkStateInconsistent,
    CoraCoworkPermissionError,
    CoraCoworkInternalError,
...
mod tests {
    ...
    fn classified_error_serializes_resolution() {
        ...
        let json = serde_json::to_value(payload).unwrap();
        assert_eq!(json["code"], "CORA_COWORK_CONVERSATION_BUSY");
