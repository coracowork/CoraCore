...
use cora_cowork_api_types::{ConversationRuntimeSummary, WebSocketMessage};
use cora_cowork_common::{ErrorChain, normalize_keys_to_snake_case, now_ms};
use cora_cowork_db::models::MessageRow;
use cora_cowork_db::{ConversationRowUpdate, DbError, IConversationRepository, MessageRowUpdate};
...
impl StreamPersistenceAdapter {
    ...
    #[tracing::instrument(skip_all)]
    pub async fn persist_tool_call(&self, data: &cora_cowork_ai_agent::protocol::events::tool_call::ToolCallEventData) {
    ...
    pub async fn persist_acp_tool_call(
        &self,
        data: &cora_cowork_ai_agent::protocol::events::tool_call::AcpToolCallEventData,
    ) {
    ...
    #[tracing::instrument(skip_all)]
    pub async fn persist_tool_group(&self, entries: &[cora_cowork_ai_agent::protocol::events::tool_call::ToolGroupEntry]) {
