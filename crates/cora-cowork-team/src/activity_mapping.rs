...
//!
//! Keeps the projection out of `cora-cowork-api-types` (which must not depend on
//! domain types) and out of the repository layer.

use cora_cowork_api_types::{TeamActivityItemResponse, TeamActivityKind, TeamMailboxMessageResponse, TeamTaskResponse};
use cora_cowork_db::PageDirection;
use cora_cowork_db::models::{MailboxMessageRow, TeamTaskRow};
use tracing::warn;
