...
use cora_cowork_api_types::{TeamAgentResponse, TeamResponse};
...
mod tests {
    ...
    #[test]
    fn teammate_status_parse_cora_cowork_aliases() {
    ...
    #[test]
    fn teammate_status_serde_cora_cowork_aliases() {
    ...
    #[test]
    fn team_agent_deserialize_cora_cowork_format() {
